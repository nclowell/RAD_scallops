...
"Allele1_WA_Strait" + '\t' + "Allele2_WA_Strait" + '\t' +
"Allele1_WA_SanJuans" + '\t' + "Allele2_WA_SanJuans" + '\t' +
"Allele1_WA_Dabob" + '\t' + "Allele2_WA_Dabob"+ '\t' +
"Allele1_AK" + '\t' + "Allele2_AK" + '\t' +
"Allele1_CA_Catalina" + '\t' + "Allele2_CA_Catalina" + '\t'
