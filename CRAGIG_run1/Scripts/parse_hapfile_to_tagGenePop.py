...
# WRITE GENOTYPES LINES
# numpops = len(unique_pops)
# for i in range(0,numpops):
#     pop_indeces = index_list[i] # retrieve indeces from this pop from list we made earlier
#     poprows = loop_array[pop_indeces] # get rows of just this pop
#     string_to_print = "" # initiate string to write to file
#     for row in poprows: # write loop that will write sample name, comma, and row out to string, for output file
#         popsamps_array = np.array(header_sample_list)[indeces]
#         print popsamps_array
#         for sample in popsamps_array:
#             string_to_print += sample + ","
#             for object in row:
#                 string_to_print += "\t" + object
#             string_to_print += "\n"
#     output.write("pop" + "\n" + string_to_print)
# output.close()
