...
#
# 20170418
# I removed the "pop"s from the Genepop file, other than the first, so that hierfstat
...
#
# The input file is kind of bananas because
# ---------------------------------------------------------------------------------
...
my_data <-read.genepop("postMAF_postMV_asGP_onepopTWICE_20170322.gen", ncode = 2)
