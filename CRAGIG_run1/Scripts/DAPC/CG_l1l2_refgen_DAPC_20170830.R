...
setwd("E:/Moved_bioinformatics_files/CRAGIG_RUNS_12_py/CG_L1_L2_refgen_001_outfiles/new_outfiles")

# Read in structure file, with a ".str" file extension
data_all_loci <-read.structure("CG_L1_L2_refgen_001_biall_NOmaf_oneSNP_inames_pops.str")
